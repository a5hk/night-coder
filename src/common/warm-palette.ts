...
function warmVariant(): Palette {
  ...
  p.defaultLibraryClassTypeColor = new Color("#dfca9f");
  ...
  p.keywordColor = new Color("#ff8833", "Keyword");
  p.literalConstantColor = new Color("#b999fa", "Literal constant");
  p.namespaceClassStructColor = new Color("#dfca9f", "Namespace/Class/Struct");
  ...
  p.metaTagColor = new Color("#ff8833", "HTML meta tag");
  p.objectTagColor = new Color("#ff8833", "HTML object tag");
  ...
  p.jsonLevel05Color = new Color("#dfca9f", "Level 5 JSON key");
